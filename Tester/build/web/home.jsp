<%-- 
    Document   : testhome
    Created on : Jun 18, 2017, 10:29:50 AM
						...
						<div class="panel-heading">
							...
							<div class="panel-body">
								<table class="table table-hover table-striped" id="info_table">
										<tr><td>Name</td><td><%=(String)hs.getAttribute("name")%></td></tr>
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" id="editor_form">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <label><strong><%=(String)hs.getAttribute("name")%></label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="youremail" class="col-sm-3 control-label">Email</label>
                                                    <div class="col-sm-9">
                                                        <label><strong><%=(String)hs.getAttribute("id")%></label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
